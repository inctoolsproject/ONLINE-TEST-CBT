...
class Template
{
    ...
    public function get_avatar($id = 0, $gender = '', $size = 0, $thumb = false, $class = '')
    {
        ...
        echo '<img class="img-avatar' . $class_f . '" src="' . $this->assets_folder . '/media/avatars/' . $id_f . '.jpg" alt="">' . "\n";
    }
    public function get_avatar_mhs($id = 0, $gender = '', $size = 0, $thumb = false, $class = '')
    {
        $id_f       = ($id ? $id : ($gender ? ($gender == 'female' ? rand(1, 8) : rand(9, 16)) : rand(1, 16)));
        $class_f    = '';
