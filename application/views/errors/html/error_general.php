...
<head>
	...
	<meta property="og:title" content="404 | OnlineTest">
				...
				<div class="hero-inner text-center">
					<div class="bg-white">
						<div class="content content-full overflow-hidden">
							<div class="py-4">
								<h4 class="h1 font-w400 text-city">Error :(</h4>
								<h2 class="h4 font-w400 text-muted mb-5">Halaman tidak ditemukan</h2>
								<code><?= $heading . '<br>' . $message; ?></code>
							</div>
						</div>
					</div>
				</div>
